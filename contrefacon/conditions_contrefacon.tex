...
\ok{valable} &
-- demande de brevet: le droit exclusif d'exploitation nait au dépôt de la demande &
L613-1\\

&
-- demande publiée ou notifiée: les faits = actes de contrefaçon à partir de la publication de la demande
ou à partir de la notification au contrefacteur présumé &
L615-4\\

\nok{pas valable} &
-- demande modifiée: jusqu'à la délivrance pas opposable $\Rightarrow$ sauf renotification au contrefacteur
présumé &
\\
